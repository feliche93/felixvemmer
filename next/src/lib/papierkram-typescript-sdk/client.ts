...
export class client {
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.bankingBankConnectionBankverbindung = new BankingBankConnectionBankverbindungService(this.request);
        ...
        this.incomePaymentTermZahlungsbedingungen = new IncomePaymentTermZahlungsbedingungenService(this.request);
        this.incomePropositionWareOderDienstleistung = new IncomePropositionWareOderDienstleistungService(this.request);
