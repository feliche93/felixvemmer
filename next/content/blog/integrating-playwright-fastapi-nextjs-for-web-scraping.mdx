...
To run them, you must connect to a browser instance via websockets. [Browserless.io](https://www.browserless.io/?ref=felixvemmer.com) is one option and has a good tutorial on it:

[Vercel + Puppeteer](https://dev.to/joelgriffith/vercel-puppeteer-4l7c?ref=felixvemmer.com)
...
[GitHub - drwpow/openapi-typescript: Generate TypeScript types from OpenAPI 3 specs](https://github.com/drwpow/openapi-typescript/tree/main?ref=felixvemmer.com)
