...
<Callout icon={<Icons.lightBulb />} className="mt-4">
...
<Callout icon={<Icons.alertTriangle />} className="mt-4">
...
[Migrating User Auth: Supabase to Clerk.dev Guide](https://www.felixvemmer.com/blog/migrate-user-authentication-supabase-clerk-dev/)
