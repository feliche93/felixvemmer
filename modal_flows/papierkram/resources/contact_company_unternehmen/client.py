...
from .types.get_contact_companies_request_order_direction_item import GetContactCompaniesRequestOrderDirectionItem
from .types.post_contact_companies_request_people_item import PostContactCompaniesRequestPeopleItem
