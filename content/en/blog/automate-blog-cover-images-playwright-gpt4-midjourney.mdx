...
Then I thought, why not try Stable diffusion? But yet again, the results left a lot to be desired. I just wasn't hitting the mark. I'd heard a lot of buzz around [Midjourney](https://www.midjourney.com/app/?ref=felixvemmer.com), so I figured, why not give it a shot?
...
<Callout className="mt-4" icon="1️⃣">
  Blog Post Title: **10 Unique Gift Ideas for a 9-Year-Old Girl**
</Callout>

<Callout title="Generated Prompt" className="mt-4" icon="🤖">
...
<Image
  ...
  height={600}
/>
By the way, if you're interested, I'll soon be offering the stock images prompt generator as a free
tool on BacklinkGPT.com. Additionally, I also recommend [Yuyu's
opengraph.xyz](https://www.yuurrific.com/blog/selling-opengraph) tool for checking how your blog
post will look on social media.
...
Free SEO Tools by [BacklinkGPT.com](https://www.backlinkgpt.com/free-seo-tools?ref=felixvemmer.com)
...
Being a programmer who values efficiency (okay, maybe a little lazy), I hit up Google to find any existing solutions. I found a few overpriced unofficial API services and a [Medium article](https://medium.com/@neonforge/how-to-automate-midjourney-image-generation-with-python-and-gui-automation-ac9ca5f747ae?ref=felixvemmer.com) that leaned heavily on PyAutoGUI. But since I wanted to keep working while the script was running, I started looking into web browser automation.
...
A little known secret to automation is to actually write as little code as possible by leveraging `GPT-4` and the [`playwright codegen`](https://playwright.dev/python/docs/codegen?ref=felixvemmer.com) utility.

I started of generating 70% of the code by running the following simple command:

``playwright codegen [`https://discord.com/channels/[server_id]/[channel_id]`](https://discord.com/channels/1124815914815201481/1124815915297542217?ref=felixvemmer.com)``
...
With a little bit of debugging, the final script was ready to roll. I've shared it in this [GitHub Gist](https://gist.github.com/feliche93/0c928a9ca2ee8bc9b907173a007b3868?ref=felixvemmer.com) for you to take, tweak, and tailor to your needs.
